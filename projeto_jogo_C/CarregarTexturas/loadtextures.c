...
void Carregar(){
    ...
    tente_novamente_2= LoadTexture("assets/tente_novamente_2.png");
    sair_azul= LoadTexture("assets/sair_azul.png");
}
...
void Descarregar(){
    ...
    UnloadTexture(tente_novamente_2);
    UnloadTexture(sair_azul);
}